            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><a href="show.php"><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Back to List of Softwares</a></span></h4>
                        <?php
                                    ...
                                    <td class="text-center">
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="trash_view.php?id=<?php echo $item['id'] ?>"><i class="icon-info22"></i>View</a></li>
                                                    <li><a href="restore.php?id=<?php echo $item['id'] ?>"><i class=" icon-spinner11"></i>Restore</a></li>
                                                    <li><a href="delete.php?id=<?php echo $item['id']; ?>"><i class=" icon-x"></i>Delete</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
