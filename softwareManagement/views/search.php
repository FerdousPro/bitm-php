...
if (isset($_GET['lab_search']) && empty($_GET['soft_search'])) {
    $allData = $obj->searchlab($_GET);
}
if (isset($_GET['soft_search'])) {
    $shobData = $obj->searchSoft($_GET);
}
?>
...
<div class="page-container">
    ...
    <div class="page-content">
                ...
                <div class="sidebar-category sidebar-category-visible">
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li><a href="#"><i class="icon-list-unordered"></i> <span>Course Management</span></a></li>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><a href="../index.php"><i class=" icon-home"></i> <span class="text-semibold">Home</a></span></h4>
            ...
            <!-- Content area -->
            <div class="content">
                <?php if (isset($allData) && empty($shobData)){ ?>
                <!--Software Search datatable -->
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">List of softwares</h5>
                        <div class="heading-elements">
                            <!--                            <ul class="icons-list">-->
                ...
                <!-- /Lab search datatable -->
                <?php   }  ?>


                <?php if (isset($shobData) && !empty($shobData)){ ?>
                <!-- Software Search datatable -->
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">List of softwares</h5>
            ...
            <table class="table datatable-basic">
                ...
                <?php
                if(!empty($shobData)){
                    foreach ($shobData as $value){
                        ?>
                        <tr>
                            <td><?php echo $value['labinfo_id'] ?></td>
                            <td><?php echo $value['software_title']?></td>
                            <td><?php echo $value['version']?></td>
                            <td><?php echo $value['software_type']?></td>
                            ...
                            <td class="text-center">
                                <ul class="icons-list">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="view.php?id=<?php echo $value['id'] ?>"><i class="icon-info22"></i>View</a></li>
                                            <li><a href="edit.php?id=<?php echo $value['id'] ?>"><i class="icon-pencil4"></i>Edit</a></li>
                                            <li><a href="trash.php?id=<?php echo $value['id']; ?>"><i class=" icon-x"></i>Delete</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </td>
